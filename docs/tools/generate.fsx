...
let githubLink = "http://github.com/exira/aws-s3-cache-cleanup"

// Specify more information about your project
let info =
  [ "project-name", "aws-s3-cache-cleanup"
    "project-author", "exira"
    "project-summary", "Exira.AwsS3Cache.Cleanup is a task which cleans up expired cached objects from AWS S3"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Exira.AwsS3Cache.Cleanup" ]
