...
let project = "Exira.AwsS3Cache.Cleanup"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Exira.AwsS3Cache.Cleanup is a task which cleans up expired cached objects from AWS S3"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Exira.AwsS3Cache.Cleanup is a task which cleans up expired cached objects from AWS S3"
...
let solutionFile  = "aws-s3-cache-cleanup.sln"
...
let gitName = "aws-s3-cache-cleanup"
